...
namespace ClientMicrosoftSql
{
    class ClientMicrosoftSql
    {
        static void Main(string[] args)
        {
            ...
            Orm orm = new("MicrosoftSql", connectionString);

            Console.WriteLine("----------------------------");
            Console.WriteLine("DDL [START]");
            // orm.Create();

            Console.WriteLine("WYWOLANIE CREATE ALL TABLES");
            ...
            var books = new List<Dictionary<string, object>>
       {
           ...
           // Console.WriteLine("pierwsze ksiazki wg atrybutu publishera [KONIEC]");
            ...
            /*List<Dictionary<string, object>> records = orm.GetAll<Book>();
